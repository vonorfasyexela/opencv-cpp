...
int main(int argc, char const *argv[])
{
    ...
    if (is_number(input))
    {
        ...
        {
            cout << "\t" << i << " - " << videoio_registry::getBackendName(camera_backends.at(i)) << endl;
        } 
        ...
        cout << "We are opening camera " << input << endl;
        cap.open(stoi(input), camera_backends.at(sel_backend_index));
    }
    else
    {
